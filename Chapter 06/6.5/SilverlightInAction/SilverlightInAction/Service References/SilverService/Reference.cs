...
namespace SilverlightInAction.SilverService {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="WsUser", Namespace="http://tempuri.org/")]
    ...
    public interface SampleAsmxSoap {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/SetSomething", ReplyAction="*")]
        System.IAsyncResult BeginSetSomething(SilverlightInAction.SilverService.SetSomethingRequest request, System.AsyncCallback callback, object asyncState);
        
        SilverlightInAction.SilverService.SetSomethingResponse EndSetSomething(System.IAsyncResult result);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    [System.ServiceModel.MessageContractAttribute(IsWrapped=false)]
    public partial class SetSomethingRequest {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Name="SetSomething", Namespace="http://tempuri.org/", Order=0)]
        public SilverlightInAction.SilverService.SetSomethingRequestBody Body;
        
        public SetSomethingRequest() {
        }
        
        public SetSomethingRequest(SilverlightInAction.SilverService.SetSomethingRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Namespace="http://tempuri.org/")]
    public partial class SetSomethingRequestBody {
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=0)]
        public int count;
        
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=1)]
        public SilverlightInAction.SilverService.WsUser myObject;
        
        public SetSomethingRequestBody() {
        }
        
        public SetSomethingRequestBody(int count, SilverlightInAction.SilverService.WsUser myObject) {
            this.count = count;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    [System.ServiceModel.MessageContractAttribute(IsWrapped=false)]
    public partial class SetSomethingResponse {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Name="SetSomethingResponse", Namespace="http://tempuri.org/", Order=0)]
        public SilverlightInAction.SilverService.SetSomethingResponseBody Body;
        
        public SetSomethingResponse() {
        }
        
        public SetSomethingResponse(SilverlightInAction.SilverService.SetSomethingResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SetSomethingResponseBody {
        
        public SetSomethingResponseBody() {
        }
    }
    ...
    public partial class SampleAsmxSoapClient : System.ServiceModel.ClientBase<SilverlightInAction.SilverService.SampleAsmxSoap>, SilverlightInAction.SilverService.SampleAsmxSoap {
        ...
        private BeginOperationDelegate onBeginSetSomethingDelegate;
        
        private EndOperationDelegate onEndSetSomethingDelegate;
        
        private System.Threading.SendOrPostCallback onSetSomethingCompletedDelegate;
        ...
        public event System.EventHandler<System.ComponentModel.AsyncCompletedEventArgs> SetSomethingCompleted;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SilverlightInAction.SilverService.SampleAsmxSoap.BeginSetSomething(SilverlightInAction.SilverService.SetSomethingRequest request, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSetSomething(request, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private System.IAsyncResult BeginSetSomething(int count, SilverlightInAction.SilverService.WsUser myObject, System.AsyncCallback callback, object asyncState) {
            SilverlightInAction.SilverService.SetSomethingRequest inValue = new SilverlightInAction.SilverService.SetSomethingRequest();
            inValue.Body = new SilverlightInAction.SilverService.SetSomethingRequestBody();
            inValue.Body.count = count;
            inValue.Body.myObject = myObject;
            return ((SilverlightInAction.SilverService.SampleAsmxSoap)(this)).BeginSetSomething(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SilverlightInAction.SilverService.SetSomethingResponse SilverlightInAction.SilverService.SampleAsmxSoap.EndSetSomething(System.IAsyncResult result) {
            return base.Channel.EndSetSomething(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private void EndSetSomething(System.IAsyncResult result) {
            SilverlightInAction.SilverService.SetSomethingResponse retVal = ((SilverlightInAction.SilverService.SampleAsmxSoap)(this)).EndSetSomething(result);
        }
        
        private System.IAsyncResult OnBeginSetSomething(object[] inValues, System.AsyncCallback callback, object asyncState) {
            int count = ((int)(inValues[0]));
            SilverlightInAction.SilverService.WsUser myObject = ((SilverlightInAction.SilverService.WsUser)(inValues[1]));
            return this.BeginSetSomething(count, myObject, callback, asyncState);
        }
        
        private object[] OnEndSetSomething(System.IAsyncResult result) {
            this.EndSetSomething(result);
            return null;
        }
        
        private void OnSetSomethingCompleted(object state) {
            if ((this.SetSomethingCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.SetSomethingCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void SetSomethingAsync(int count, SilverlightInAction.SilverService.WsUser myObject) {
            this.SetSomethingAsync(count, myObject, null);
        }
        
        public void SetSomethingAsync(int count, SilverlightInAction.SilverService.WsUser myObject, object userState) {
            if ((this.onBeginSetSomethingDelegate == null)) {
                this.onBeginSetSomethingDelegate = new BeginOperationDelegate(this.OnBeginSetSomething);
            }
            if ((this.onEndSetSomethingDelegate == null)) {
                this.onEndSetSomethingDelegate = new EndOperationDelegate(this.OnEndSetSomething);
            }
            if ((this.onSetSomethingCompletedDelegate == null)) {
                this.onSetSomethingCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnSetSomethingCompleted);
            }
            base.InvokeAsync(this.onBeginSetSomethingDelegate, new object[] {
                        count,
                        myObject}, this.onEndSetSomethingDelegate, this.onSetSomethingCompletedDelegate, userState);
        }
        ...
        private class SampleAsmxSoapClientChannel : ChannelBase<SilverlightInAction.SilverService.SampleAsmxSoap>, SilverlightInAction.SilverService.SampleAsmxSoap {
            ...
            public System.IAsyncResult BeginSetSomething(SilverlightInAction.SilverService.SetSomethingRequest request, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = request;
                System.IAsyncResult _result = base.BeginInvoke("SetSomething", _args, callback, asyncState);
                return _result;
            }
            
            public SilverlightInAction.SilverService.SetSomethingResponse EndSetSomething(System.IAsyncResult result) {
                object[] _args = new object[0];
                SilverlightInAction.SilverService.SetSomethingResponse _result = ((SilverlightInAction.SilverService.SetSomethingResponse)(base.EndInvoke("SetSomething", _args, result)));
                return _result;
            }
        }
    }
